        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    Longitude = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceCategoryId = table.Column<long>(type: "bigint", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReferencePrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Places_CostCategories_CostCategoryId",
                        column: x => x.CostCategoryId,
                        principalTable: "CostCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Places_Currencies_CurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanningMode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: true),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: true),
                    TravelerCount = table.Column<int>(type: "int", nullable: false),
                    BudgetAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    BudgetCurrencyId = table.Column<long>(type: "bigint", nullable: true),
                    TotalEstimatedCost = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trips_Currencies_BudgetCurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIGenerations_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CostEstimates_CostCategories_CostCategoryId",
                        column: x => x.CostCategoryId,
                        principalTable: "CostCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CostEstimates_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CostEstimates_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiGenerationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripInterests", x => new { x.TripId, x.InterestCategoryId });
                    table.ForeignKey(
                        name: "FK_TripInterests_InterestCategories_InterestCategoryId",
                        column: x => x.InterestCategoryId,
                        principalTable: "InterestCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TripInterests_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CostCategories_Code",
                table: "CostCategories",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CostEstimates_CostCategoryId",
                table: "CostEstimates",
                column: "CostCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CostEstimates_CurrencyId",
                table: "CostEstimates",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_CostEstimates_TripId",
                table: "CostEstimates",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_CostEstimates_TripId_CostCategoryId",
                table: "CostEstimates",
                columns: new[] { "TripId", "CostCategoryId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterestCategories_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaceCategories_Code",
                table: "PlaceCategories",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Places_CostCategoryId",
                table: "Places",
                column: "CostCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Places_CurrencyId",
                table: "Places",
                column: "CurrencyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripInterests_InterestCategoryId",
                table: "TripInterests",
                column: "InterestCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Trips_BudgetCurrencyId",
                table: "Trips",
