...
| Rania Muhamid | UI/UX / Graphic Design | **TBD — Pending Capability Analysis** |
...
**Capability summary:** No training/capability document was provided for this track.
**Responsibilities:** **TBD — Pending Capability Analysis.** Do not assign UI/UX ownership, design-system authority, or accessibility responsibility without a capability review, per the constraint against inventing capabilities.
...
| Design system / visual design | **TBD** | Dana Yaseen (implementation) | UI/UX | Capability analysis |
...
**UI/UX (Rania):** TBD — Pending Capability Analysis.
...
| UI/UX ↔ Flutter | — | Design specs → Flutter implementation | Screens, design tokens | Blocked until Rania's capability/responsibility is confirmed |
...
4. Where no evidence exists (UI/UX, Cybersecurity), the responsibility is marked TBD rather than invented.
...
| Team-wide | UI/UX capability unknown | Any UI/UX-owned deliverable |
