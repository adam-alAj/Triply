...
| ----------------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `place_id`              | *(none)*                           | Curation-local join key back to `Place.csv`, not persisted                                                                                                                                                                                                                                                                         |
| `place_name`            | *(none)*                           | Redundant, for human readability while editing                                                                                                                                                                                                                                                                                     |
| `budget_tier`           | *(none)*                           | Prompt-context only                                                                                                                                                                                                                                                                                                                |
| `suitable_travel_style` | *(none)*                           | Prompt-context only                                                                                                                                                                                                                                                                                                                |
| `interest_tag`          | *(none — no DB column exists yet)* | Advisory prompt-context only. **The currently approved schema has no Place↔Interest relationship.** A candidate `PlaceInterest` junction table is proposed separately in `AI/05-Destination-Suggestion/Interest_Aware_Destination_Suggestions_Spec.md`, pending Backend decision. Until that lands, this column is never imported. |
| `source_url`            | *(none)*                           | Provenance/audit only                                                                                                                                                                                                                                                                                                              |
| `notes`                 | *(none)*                           | Provenance/audit only, e.g. "verify seasonal rate" flags                                                                                                                                                                                                                                                                           |

This file is versioned in the same manifest as the importable CSVs (same
integrity guarantee) but is explicitly out of scope for `seed_places.py`.
